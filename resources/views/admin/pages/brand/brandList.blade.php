                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a onclick="openModal({{$myJSON}})" href="#" class="btn btn-warning btn-sm" role="button" data-toggle="modal"
                                            data-target="#UpdatebrandModal">Update</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="formUpdate" action="admin/form/brand/update" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Brand Detail</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="admin/form/brand/add" method="POST">
                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> <!--Phải thêm-->
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Brand Name</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Brand Detail</label>
...
function openModal(e){
    ...
    $formDelete.action="admin/form/brand/delete/"+e.id;

    $formUpdate.action = "admin/form/brand/update/"+e.id;
