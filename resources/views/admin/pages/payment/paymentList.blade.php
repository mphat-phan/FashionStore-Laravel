                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a onclick="openModal({{$myJSON}})" href="#" class="btn btn-warning btn-sm" role="button" data-toggle="modal"
                                            data-target="#UpdatepaymentModal">Update</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="formUpdate" action="admin/form/payment/update" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="admin/form/payment/add" method="POST">
                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> <!--Phải thêm-->
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">payment Name</label>
...
function openModal(e){
    ...
    $formDelete.action="admin/form/payment/delete/"+e.id;

    $formUpdate.action = "admin/form/payment/update/"+e.id;
